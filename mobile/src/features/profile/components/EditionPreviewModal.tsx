...
interface EditionPreviewModalProps {
  visible: boolean;
  editionName: ThemeName | null;
  onClose: () => void;
  onApply: (name: ThemeName) => void;
  isActive: boolean;
}

export function EditionPreviewModal({
  visible,
  editionName,
  onClose,
  onApply,
        ...
        >
          ...
          >
            ...
            <View style={[styles.previewContent, { padding: previewTheme.spacing.md }]}>
              <MockBookCard previewTheme={previewTheme} />
            ...
            <View
              style={[
                styles.infoSection,
                {
                  ...
                  borderBottomLeftRadius: previewTheme.radii.xl - 1,
                  borderBottomRightRadius: previewTheme.radii.xl - 1,
                },
              ]}
            >
              <Text
...
function MockBookCard({ previewTheme }: { previewTheme: Theme }) {
  return (
    <View
      style={[
        styles.mockBookCard,
      ...
      >
        <View style={styles.coverLines}>
          <View
            style={[
              styles.coverLine,
              { backgroundColor: previewTheme.colors.onPrimary, opacity: 0.3 },
            ]}
          />
          <View
            style={[
              styles.coverLine,
              styles.coverLineShort,
              { backgroundColor: previewTheme.colors.onPrimary, opacity: 0.2 },
            ]}
          />
        </View>
      </View>
